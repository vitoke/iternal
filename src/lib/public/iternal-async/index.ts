...
//   Pred
// } from '../constants'
// import { Collectors } from '../iternal-fold/folds'
// import { Collector, MonoFun } from '../iternal-fold/gen-folder'
...
//    * ```
//    */
//   async fold<R>(folder: Collector<T, R>): Promise<R> {
...
//    * ```
//    */
//   foldIter<R>(folder: Collector<T, R>): AsyncIter<R> {
...
//     return this.filter(pred).map((_, i) => i)
//   }
